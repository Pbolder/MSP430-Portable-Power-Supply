...
void Safety_Update100ms(unsigned char buckCurrentSampleValid)
{
    ...
    /*
     * three consecutive 2.7 A readings trips immediately.  After shutdown, the
     * measured current must remain below 0.5 A for one second before
     * another manual enable request is accepted.
     */
