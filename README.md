...
The full design calculations, component-selection reasoning, schematics, BOM, development history, and testing discussion are available in the
[Full engineering report](MSP430-Programmable-Power-Supply/documentation/MSP430-Programmable-Power-Supply-Engineering-Report.pdf).
...
![System block diagram](MSP430-Programmable-Power-Supply/images/system-block-diagram.png)
...
| --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| ![LTspice power-stage model](MSP430-Programmable-Power-Supply/images/ltspice-power-stage.png) | ![LTspice startup waveforms](MSP430-Programmable-Power-Supply/images/ltspice-startup-waveforms.png) |
...
| --------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- |
| ![Four-layer PCB routing](MSP430-Programmable-Power-Supply/hardware/pcb/pcb-layout.png) | ![PCB 3D render](MSP430-Programmable-Power-Supply/hardware/pcb/pcb-3d-render.png) |
