...
The full design calculations, component-selection reasoning, schematics, development history, and testing discussion are available in the [Full engineering report](documentation/MSP430-Programmable-Power-Supply-Engineering-Report.pdf).
